...
class TestAuthorizedUser(TestCase):
    ...
    def test_create_one_user_with_all_fields_filled_successful(self, mock_get_users_from_api, mock_get_pictures):
        mock_get_users_from_api.json.return_value = mock_api_data(1)
    ...
    def test_create_one_user_with_no_fields_passed_all_fields_filled(self, mock_get_users_from_api, mock_get_pictures):
        ...
        mock_get_users_from_api.return_value.json.return_value = mock_api_data(1)
    ...
    # @mock.patch('apps.users.views.requests.get')
    # def test_filled_fields_being_used_rest_from_external_api(self, fake_get):
    #     mock_users(1, fake_get)
    #
    #     payload = {
    #         "first_name": "Test",
    #         "last_name": "Test Last",
    ...
    #
    # @mock.patch('apps.users.views.requests.get')
    # def test_fields_passed_being_user_in_one_generated_users_rest_random(self, fake_get):
    #     mock_users(4, fake_get)
    #     payload = [
    #         {
    #             "first_name": "Test",
    #             "last_name": "Test Last",
    ...
    #
    # @mock.patch('apps.users.views.requests.get')
    # def test_list_all_users_successful(self, fake_get):
    #     mock_users(3, fake_get)
    #
    ...
    #
    # @mock.patch('apps.users.views.requests.get')
    # def test_show_user_detail_successful(self, fake_get):
    #     mock_users(1, fake_get)
    #
    ...
    #
    # @mock.patch('apps.users.views.requests.get')
    # def test_update_user_successful(self, fake_get):
    #     mock_users(1, fake_get)
    #
    #     self.client.post(CREATE_NO_PARAM, data=USER, format="json")
    #     created_user = User.objects.get(email=USER[0]["email"])
    ...
    #
    # @mock.patch('apps.users.views.requests.get')
    # def test_delete_user_successful(self, fake_get):
    #     mock_users(1, fake_get)
    #
    #     self.client.post(CREATE_NO_PARAM, data=USER, format="json")
    #     created_user = User.objects.get(email=USER[0]["email"])
